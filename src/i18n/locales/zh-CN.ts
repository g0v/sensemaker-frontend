export default {
  ...
  guideModal: {
    ...
    polisTitle: '1. 意见调查报告导出',
    polisDescription: '本工具支持 Polis 和 Agora 平台导出的意见调查报告。请确保您资料CSV档符合正确的数据结构。',
    polisGuideLink: '查看Polis使用说明 →',
    agoraGuideLink: '查看Agora Citizen使用说明 →',
  ...
  // Agora 导览页
  agoraGuide: {
    title: '「Agora Citizen 公民审议平台」使用说明',
    subtitle: 'V1 · 支持语言：英文、西班牙文、法文、简体中文、繁体中文、日文、阿拉伯文',
    mvpNote: '本导览为 MVP 版本说明；目前官方网站已更新为正式版。',
    mainWebsite: '主网站：',
    officialVideo: '官方介绍影片：',
    youtubeLink: 'YouTube 连结',
    focusTitle: '焦点',
    focusBeforeLink: '以往民主政治有一个很大的难题，就是当人数变多的时候要进行直接民主的公民审议、综合整理大家的意见就几乎不可能做到，所以政治上所谓的「寡头铁律」——民主在大规模的国家层次，难免成为代议士与菁英的少数统治。Agora Citizen 是一个试图协助社会跨越极化对立、突破寡头铁律限制的异步公民审议平台，由',
    focusLinkText: 'ZKorum 团队',
    focusAfterLink: '研发。',
    focusSuffix: '以商业模式营运、开放源码释出原始码。',
    step0Title: '点击「Try the MVP」开始使用',
    step0Description: '前往主网站后，点击「Try the MVP」即可开始使用 MVP（最小可动产品）。',
    step0LinkText: '前往 Agora Citizen 主网站',
    step1Title: '注册账号',
    step1Login: '点击右上角「登入」按钮。',
    step1Register: '点击「注册」按钮。',
    step1Next: '看完说明请点击「箭头」下一步。',
    step2Title: '手机认证',
    step2Phone: '点选「使用手机号验证」。',
    step2Verify: '输入手机号码之后，点选「箭头」。输入验证码，就能完成认证。',
    step3Title: '填基本资料',
    step3Bullet1: '进入之后，系统会先请你输入你的使用者名称，注意只能使用小写的英文、阿拉伯数字和底线。',
    step3Bullet2: '接着系统会请你选择你会的语言。',
    step3Bullet3: '然后，系统会请你选择你关心的主题类别（例如艺术与文化），可复选。',
    step4Title: '参与议题',
    step4Enter: '先点击进入一个议题。',
    step4ScrollBefore: '往下卷动会看到许多意见。可以使用翻译软件（如',
    step4ScrollLink: 'Google 翻译',
    step4ScrollAfter: '）协助理解意见内容。',
    voteTitle: '投票',
    voteDescription: '针对每个意见，你可以投票：同意、不同意、跳过。投完票之后即可看到其他人的投票数量和比例，一开始不显示是为了避免影响独立思考判断。',
    reportTitle: '看分析报告',
    reportTabsDesc: '每一个对话有两个分页：「意见」与「分析」。点击分页标签可切换。',
    reportFourDimensions: '分析报告有四个项度可切换显示：总结、共同点、分歧、群组。',
    reportSummary: '总结',
    reportSummaryDesc: '同时显示共同点、分歧、群组。',
    reportCommon: '共同点',
    reportCommonDesc: '专注在全部参与者不分群组都较多赞成的意见，可建立「罕见共识」。',
    reportDivergence: '分歧',
    reportDivergenceDesc: '专注在争议点和群组间的意见冲突。',
    reportGroups: '群组',
    reportGroupsDesc: 'AI 将投票的人分成群落，可看各群落较多赞成／反对的意见（蓝色：较多赞成、黄色：较多反对）。意见数量够多时也可看到自己被归类到哪一群。',
    publishTitle: '发表意见',
    publishDescription: '您也可以在对话中发表自己的意见，发表的意见将自动设定您自己为「赞成」。',
    step5Title: '发起议题',
    step5Description: '按左下角的「开始对话」即可发起新议题。',
    etymologyTitle: 'Agora 的字源',
    etymologyBefore: '此平台命名 Agora 源自古希腊的市民广场',
    etymologyLink: 'Agora',
    etymologyAfter: '，那也是古雅典哲人苏格拉底常与众人对话讨论的地方。',
    supportTitle: '支援、功能请求与错误回报',
    supportDiscussionLabel: '使用心得讨论：',
    supportDiscussionLinkText: 'vTaiwan 审议民主 Slack 频道',
    supportIssuesLabel: '功能请求与错误回报：',
    supportIssuesLinkText: '母专案议题区 (GitHub)',
    backToHome: '返回首页',
    nextGuide: 'Open Router 使用说明'
  },
