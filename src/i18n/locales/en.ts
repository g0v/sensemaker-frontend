export default {
  ...
  selfHost: {
    ...
    viewBackendProject: 'View Backend Project',
    ...
    viewFrontendProject: 'View Frontend Project',
  ...
  guideModal: {
    ...
    polisTitle: '1. Opinion Survey Report Export',
    polisDescription: 'This tool supports opinion survey reports exported from Polis and Agora platforms. Please ensure your CSV data file conforms to the correct data structure.',
    polisGuideLink: 'View Polis Guide →',
    agoraGuideLink: 'View Agora Citizen Guide →',
  ...
  // Agora Guide Page
  agoraGuide: {
    title: 'Agora Citizen Deliberation Platform Guide',
    subtitle: 'V1 · Supported languages: English, Spanish, French, Simplified Chinese, Traditional Chinese, Japanese, Arabic',
    mvpNote: 'This guide describes the MVP version; the official website has been updated to the full release.',
    mainWebsite: 'Main website:',
    officialVideo: 'Official intro video:',
    youtubeLink: 'YouTube link',
    focusTitle: 'Focus',
    focusBeforeLink: 'A long-standing challenge for democracy is that as the number of participants grows, direct democratic deliberation and synthesizing everyone\'s views becomes nearly impossible—hence the "iron law of oligarchy": at scale, democracy tends to become rule by representatives and elites. Agora Citizen is an asynchronous civic deliberation platform that aims to help societies bridge polarization and go beyond that limit. It is developed by the',
    focusLinkText: 'ZKorum team',
    focusAfterLink: '.',
    focusSuffix: 'It is operated as a business and its source code is released as open source.',
    step0Title: 'Click "Try the MVP" to get started',
    step0Description: 'After visiting the main website, click "Try the MVP" to start using the MVP (Minimum Viable Product).',
    step0LinkText: 'Go to Agora Citizen main website',
    step1Title: 'Register an account',
    step1Login: 'Click the "Log in" button in the top-right corner.',
    step1Register: 'Click the "Sign up" button.',
    step1Next: 'After reading the instructions, click the "arrow" to continue.',
    step2Title: 'Phone verification',
    step2Phone: 'Select "Verify with phone number".',
    step2Verify: 'After entering your phone number, click the "arrow". Enter the verification code to complete verification.',
    step3Title: 'Fill in basic profile',
    step3Bullet1: 'After entering, the system will ask you to enter your username (lowercase letters, numbers, and underscores only).',
    step3Bullet2: 'Then the system will ask you to select the languages you speak.',
    step3Bullet3: 'Finally, the system will ask you to select topics you care about (e.g. arts and culture); multiple selections are allowed.',
    step4Title: 'Participate in topics',
    step4Enter: 'Click to enter a topic first.',
    step4ScrollBefore: 'Scroll down to see many opinions. You can use translation tools (e.g.',
    step4ScrollLink: 'Google Translate',
    step4ScrollAfter: ') to help understand the content.',
    voteTitle: 'Voting',
    voteDescription: 'For each opinion you can vote: agree, disagree, or skip. After voting you can see others\' vote counts and ratios; these are hidden at first to avoid influencing independent judgment.',
    reportTitle: 'View analysis report',
    reportTabsDesc: 'Each conversation has two tabs: "Opinions" and "Analysis". Click the tab to switch.',
    reportFourDimensions: 'The analysis report has four dimensions: Summary, Common ground, Divergence, and Groups.',
    reportSummary: 'Summary',
    reportSummaryDesc: 'Shows common ground, divergence, and groups together.',
    reportCommon: 'Common ground',
    reportCommonDesc: 'Focuses on opinions that most participants across groups agree on—building "rare consensus".',
    reportDivergence: 'Divergence',
    reportDivergenceDesc: 'Focuses on contentious points and conflicts between groups.',
    reportGroups: 'Groups',
    reportGroupsDesc: 'AI clusters voters into groups; you can see which opinions each group tends to agree or disagree with (blue: more agree, yellow: more disagree). With enough data you can also see which group you belong to.',
    publishTitle: 'Publish opinions',
    publishDescription: 'You can also publish your own opinion in the conversation; your published opinion is automatically set to "Agree" for you.',
    step5Title: 'Start a topic',
    step5Description: 'Click "Start conversation" in the bottom-left to start a new topic.',
    etymologyTitle: 'Origin of the name Agora',
    etymologyBefore: 'The platform is named after the ancient Greek civic square, ',
    etymologyLink: 'Agora',
    etymologyAfter: ', where the philosopher Socrates often held dialogues.',
    supportTitle: 'Support, feature requests & bug reports',
    supportDiscussionLabel: 'Discussion: ',
    supportDiscussionLinkText: 'vTaiwan deliberative democracy Slack channel',
    supportIssuesLabel: 'Feature requests & bug reports: ',
    supportIssuesLinkText: 'Parent project issues (GitHub)',
    backToHome: 'Back to Home',
    nextGuide: 'Open Router Guide'
  },
