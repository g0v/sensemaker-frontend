export default {
  ...
  guideModal: {
    ...
    polisTitle: '1. Export de rapport d\'enquête d\'opinion',
    polisDescription: 'Cet outil prend en charge les rapports d\'enquêtes d\'opinion exportés depuis les plateformes Polis et Agora. Veuillez vous assurer que votre fichier CSV est conforme à la structure de données correcte.',
    polisGuideLink: 'Voir le guide Polis →',
    agoraGuideLink: 'Voir le guide Agora Citizen →',
  ...
  // Page de guide Agora
  agoraGuide: {
    title: 'Guide de la plateforme de délibération citoyenne Agora Citizen',
    subtitle: 'V1 · Langues : anglais, espagnol, français, chinois simplifié, chinois traditionnel, japonais, arabe',
    mvpNote: 'Ce guide décrit la version MVP ; le site officiel a été mis à jour vers la version complète.',
    mainWebsite: 'Site principal :',
    officialVideo: 'Vidéo de présentation officielle :',
    youtubeLink: 'Lien YouTube',
    focusTitle: 'Focus',
    focusBeforeLink: 'Un défi majeur de la démocratie est qu\'avec l\'augmentation du nombre de participants, la délibération citoyenne directe et la synthèse des avis deviennent quasi impossibles—d\'où la « loi d\'airain de l\'oligarchie » : à grande échelle, la démocratie tend à devenir le gouvernement des représentants et des élites. Agora Citizen est une plateforme de délibération citoyenne asynchrone qui vise à aider les sociétés à dépasser la polarisation et cette limite. Elle est développée par l\'',
    focusLinkText: 'équipe ZKorum',
    focusAfterLink: '.',
    focusSuffix: 'Il est exploité comme une entreprise et son code source est publié en open source.',
    step0Title: 'Cliquez sur « Try the MVP » pour commencer',
    step0Description: 'Après avoir visité le site principal, cliquez sur « Try the MVP » pour utiliser le MVP (Produit Minimum Viable).',
    step0LinkText: 'Aller sur le site principal d\'Agora Citizen',
    step1Title: 'Créer un compte',
    step1Login: 'Cliquez sur le bouton « Connexion » en haut à droite.',
    step1Register: 'Cliquez sur le bouton « Inscription ».',
    step1Next: 'Après avoir lu les instructions, cliquez sur la « flèche » pour continuer.',
    step2Title: 'Vérification par téléphone',
    step2Phone: 'Sélectionnez « Vérifier par numéro de téléphone ».',
    step2Verify: 'Après avoir saisi votre numéro, cliquez sur la « flèche ». Saisissez le code de vérification pour terminer.',
    step3Title: 'Remplir le profil de base',
    step3Bullet1: 'Une fois connecté, le système vous demandera un nom d\'utilisateur (minuscules, chiffres et underscores uniquement).',
    step3Bullet2: 'Puis il vous demandera de choisir les langues que vous parlez.',
    step3Bullet3: 'Enfin, il vous demandera de choisir les sujets qui vous intéressent (ex. arts et culture) ; choix multiples possibles.',
    step4Title: 'Participer aux sujets',
    step4Enter: 'Cliquez d\'abord pour entrer dans un sujet.',
    step4ScrollBefore: 'Faites défiler pour voir les avis. Vous pouvez utiliser des outils de traduction (ex. ',
    step4ScrollLink: 'Google Traduction',
    step4ScrollAfter: ') pour comprendre le contenu.',
    voteTitle: 'Vote',
    voteDescription: 'Pour chaque avis vous pouvez voter : d\'accord, pas d\'accord ou passer. Après le vote vous verrez les votes et proportions des autres ; masqués au début pour ne pas influencer le jugement.',
    reportTitle: 'Voir le rapport d\'analyse',
    reportTabsDesc: 'Chaque conversation a deux onglets : « Avis » et « Analyse ». Cliquez sur l\'onglet pour changer.',
    reportFourDimensions: 'Le rapport a quatre dimensions : Résumé, Points communs, Divergences et Groupes.',
    reportSummary: 'Résumé',
    reportSummaryDesc: 'Affiche points communs, divergences et groupes.',
    reportCommon: 'Points communs',
    reportCommonDesc: 'Met l\'accent sur les avis avec lesquels la majorité est d\'accord dans tous les groupes—« consensus rare ».',
    reportDivergence: 'Divergences',
    reportDivergenceDesc: 'Met l\'accent sur les points controversés et les conflits entre groupes.',
    reportGroups: 'Groupes',
    reportGroupsDesc: 'L\'IA regroupe les votants ; vous pouvez voir quels avis chaque groupe approuve ou rejette (bleu : plus pour, jaune : plus contre). Avec assez de données vous verrez aussi à quel groupe vous appartenez.',
    publishTitle: 'Publier des avis',
    publishDescription: 'Vous pouvez aussi publier votre propre avis ; votre avis publié sera automatiquement marqué « D\'accord » pour vous.',
    step5Title: 'Lancer un sujet',
    step5Description: 'Cliquez sur « Démarrer une conversation » en bas à gauche pour créer un nouveau sujet.',
    etymologyTitle: 'Origine du nom Agora',
    etymologyBefore: 'La plateforme tire son nom de la place civique de la Grèce antique, l\'',
    etymologyLink: 'Agora',
    etymologyAfter: ', où le philosophe Socrate dialoguait souvent.',
    supportTitle: 'Support, demandes de fonctionnalités et signalement de bugs',
    supportDiscussionLabel: 'Discussion : ',
    supportDiscussionLinkText: 'canal Slack démocratie délibérative vTaiwan',
    supportIssuesLabel: 'Demandes et signalements : ',
    supportIssuesLinkText: 'issues du projet parent (GitHub)',
    backToHome: 'Retour à l\'accueil',
    nextGuide: 'Guide Open Router'
  },
