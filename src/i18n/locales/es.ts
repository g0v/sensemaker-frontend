export default {
  ...
  guideModal: {
    ...
    polisTitle: '1. Exportación de informe de encuesta de opinión',
    polisDescription: 'Esta herramienta soporta informes de encuestas de opinión exportados desde las plataformas Polis y Agora. Por favor asegúrese de que su archivo CSV cumpla con la estructura de datos correcta.',
    polisGuideLink: 'Ver guía de Polis →',
    agoraGuideLink: 'Ver guía de Agora Citizen →',
  ...
  // Página de guía Agora
  agoraGuide: {
    title: 'Guía de la plataforma de deliberación ciudadana Agora Citizen',
    subtitle: 'V1 · Idiomas: inglés, español, francés, chino simplificado, chino tradicional, japonés, árabe',
    mvpNote: 'Esta guía corresponde a la versión MVP; el sitio oficial ya se ha actualizado a la versión completa.',
    mainWebsite: 'Sitio web principal:',
    officialVideo: 'Vídeo de presentación oficial:',
    youtubeLink: 'Enlace de YouTube',
    focusTitle: 'Enfoque',
    focusBeforeLink: 'Un gran desafío de la democracia es que cuando crece el número de participantes, la deliberación ciudadana directa y la síntesis de opiniones se vuelve casi imposible—de ahí la "ley de hierro de la oligarquía": a gran escala, la democracia tiende a ser gobierno de representantes y élites. Agora Citizen es una plataforma de deliberación ciudadana asíncrona que busca ayudar a las sociedades a superar la polarización y ese límite. Está desarrollada por el ',
    focusLinkText: 'equipo ZKorum',
    focusAfterLink: '.',
    focusSuffix: 'Se opera como negocio y el código fuente se publica como código abierto.',
    step0Title: 'Haz clic en "Try the MVP" para empezar',
    step0Description: 'Tras visitar el sitio principal, haz clic en "Try the MVP" para usar el MVP (Producto Mínimo Viable).',
    step0LinkText: 'Ir al sitio principal de Agora Citizen',
    step1Title: 'Registrar una cuenta',
    step1Login: 'Haz clic en el botón "Iniciar sesión" en la esquina superior derecha.',
    step1Register: 'Haz clic en el botón "Registrarse".',
    step1Next: 'Después de leer las instrucciones, haz clic en la "flecha" para continuar.',
    step2Title: 'Verificación por teléfono',
    step2Phone: 'Selecciona "Verificar con número de teléfono".',
    step2Verify: 'Tras introducir tu número, haz clic en la "flecha". Introduce el código de verificación para completar.',
    step3Title: 'Completar el perfil básico',
    step3Bullet1: 'Después de entrar, el sistema te pedirá un nombre de usuario (solo minúsculas, números y guiones bajos).',
    step3Bullet2: 'Luego te pedirá que elijas los idiomas que hablas.',
    step3Bullet3: 'Por último, te pedirá que elijas temas de interés (p. ej. arte y cultura); se puede elegir más de uno.',
    step4Title: 'Participar en temas',
    step4Enter: 'Haz clic primero para entrar en un tema.',
    step4ScrollBefore: 'Desplázate hacia abajo para ver opiniones. Puedes usar herramientas de traducción (p. ej. ',
    step4ScrollLink: 'Google Translate',
    step4ScrollAfter: ') para entender el contenido.',
    voteTitle: 'Votación',
    voteDescription: 'Para cada opinión puedes votar: de acuerdo, en desacuerdo o omitir. Tras votar verás los votos y proporciones de otros; al principio no se muestran para no influir en el criterio.',
    reportTitle: 'Ver informe de análisis',
    reportTabsDesc: 'Cada conversación tiene dos pestañas: "Opiniones" y "Análisis". Haz clic en la pestaña para cambiar.',
    reportFourDimensions: 'El informe tiene cuatro dimensiones: Resumen, Puntos en común, Divergencias y Grupos.',
    reportSummary: 'Resumen',
    reportSummaryDesc: 'Muestra puntos en común, divergencias y grupos.',
    reportCommon: 'Puntos en común',
    reportCommonDesc: 'Se centra en opiniones con las que la mayoría está de acuerdo en todos los grupos—"consenso poco común".',
    reportDivergence: 'Divergencias',
    reportDivergenceDesc: 'Se centra en puntos controvertidos y conflictos entre grupos.',
    reportGroups: 'Grupos',
    reportGroupsDesc: 'La IA agrupa a los votantes; puedes ver con qué opiniones está más o menos de acuerdo cada grupo (azul: más a favor, amarillo: más en contra). Con suficientes datos también verás a qué grupo perteneces.',
    publishTitle: 'Publicar opiniones',
    publishDescription: 'También puedes publicar tu propia opinión; tu opinión publicada se marcará automáticamente como "De acuerdo" para ti.',
    step5Title: 'Iniciar un tema',
    step5Description: 'Haz clic en "Iniciar conversación" abajo a la izquierda para crear un nuevo tema.',
    etymologyTitle: 'Origen del nombre Agora',
    etymologyBefore: 'La plataforma toma su nombre de la plaza cívica de la antigua Grecia, ',
    etymologyLink: 'Agora',
    etymologyAfter: ', donde el filósofo Sócrates dialogaba a menudo.',
    supportTitle: 'Soporte, solicitudes de funciones e informes de errores',
    supportDiscussionLabel: 'Debate: ',
    supportDiscussionLinkText: 'canal Slack de democracia deliberativa vTaiwan',
    supportIssuesLabel: 'Solicitudes e informes: ',
    supportIssuesLinkText: 'Issues del proyecto (GitHub)',
    backToHome: 'Volver al inicio',
    nextGuide: 'Guía de Open Router'
  },
