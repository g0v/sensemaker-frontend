<template>
  <div class="relative">
    <button
      @click="isOpen = !isOpen"
      class="flex items-center space-x-2 px-3 py-2 rounded-lg border bg-black focus:outline-none focus:ring-2 focus:ring-democratic-red transition-colors text-white border-white hover:border-gray-300"
    >
